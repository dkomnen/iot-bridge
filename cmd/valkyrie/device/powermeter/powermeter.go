...
func (t *Powermeter) generateMessage() error {
	...
	t.opts.Broker.Publish(constants.PowerReading, data)

	return nil
}

func (t *Powermeter) sendOnlineMessage() error {
...
func (t *Powermeter) sendOfflineMessage() error {
	deviceStatus := &message.DeviceStatus{
		DeviceStatus: false,
		SerialNumber: t.opts.SerialNumber,
	}
...
func (t *Powermeter) Options() device.Options {
	return t.opts
}
