...
func (t *Hygrometer) generateMessage() error {
	...
	t.opts.Broker.Publish(constants.HumidityReading, data)

	return nil
}

func (t *Hygrometer) sendOnlineMessage() error {
...
func (t *Hygrometer) sendOfflineMessage() error {
	deviceStatus := &message.DeviceStatus{
		DeviceStatus: false,
		SerialNumber: t.opts.SerialNumber,
	}
...
func (t *Hygrometer) Options() device.Options {
	return t.opts
}
